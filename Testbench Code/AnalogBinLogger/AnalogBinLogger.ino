...
const float SAMPLE_RATE = 16000;  // Must be 0.25 or greater.
...
void logData() {
  ...
  while (1) {
    ...
    if ((count/PIN_COUNT) >= 476250) { // Serial.available() count >= 166668 158750- Aswin Modified
      // Stop ISR calls.
      adcStop();
